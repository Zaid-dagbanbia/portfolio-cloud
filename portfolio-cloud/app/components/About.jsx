    ...
    >
      ...
      transition={{duration:0.6}}
        ...
        className='flex-1'>
          ...
          className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
            {
                infoList.map(({icon,iconDark,title,description},index)=> (
                    ...
                    key={index} className='border-[0.5px] border-gray-400 rounded-x1 p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50'>
          ...
          className='my-6 text-gray-700 font-Ovo dark:text-white/80'>Tools I used</motion.h4>
